...
<?php
 ...
 $sql = "select *  , (case bj when '1'then '待发货'  when '2' then '已发货'when '3' then '作废'end ) AS bja   from dd order by id desc limit 0,$page_size";
...
</p><table width="1400" border="0" align="left" cellpadding="2" cellspacing="1" bordercolor="#315DAD" bgcolor="#315DAD">
